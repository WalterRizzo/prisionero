    ...
    <div className="min-h-screen w-full text-white flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden" style={{
      ...
      <div className="w-full max-w-2xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10">
          <h1 className="text-7xl md:text-8xl font-extrabold tracking-tight mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">⚔️ ARENA CLASH ⚔️</h1>
          <p className="text-gray-300 text-xl md:text-2xl mb-8">Batalla rápida. Competencia feroz. Sube ELO.<br/>30-45 segundos de puro CAOS total.</p>
          <Link
            to="/arena"
            className="w-full max-w-md mx-auto block text-center py-5 text-2xl font-black bg-gradient-to-r from-red-600 to-purple-600 text-white rounded-xl shadow-[0_0_30px_rgba(255,0,0,0.8)] hover:scale-105 transition-all duration-300 border-2 border-yellow-400"
          >
            ⚔️ ENTRAR A ARENA AHORA ⚔️
          </Link>
